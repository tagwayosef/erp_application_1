...
void _expenseModelSerialize(
  ...
  writer.writeBool(offsets[5], object.isCash);
...
ExpenseModel _expenseModelDeserialize(
  ...
  final object = ExpenseModel(
    ...
    creditorName: reader.readStringOrNull(offsets[2]),
    ...
    paymentMethod: reader.readStringOrNull(offsets[9]),
    paymentType: reader.readStringOrNull(offsets[10]),
    remainingAmount: reader.readDoubleOrNull(offsets[11]) ?? 0.0,
...
extension ExpenseModelQueryFilter
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition>
      creditorNameContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'creditorName',
        value: value,
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition>
      creditorNameMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'creditorName',
        wildcard: pattern,
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'date',
      ));
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> dateEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> dateContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> dateMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterFilterCondition> isCashEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isCash',
...
extension ExpenseModelQuerySortBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByCreditorName() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByIsCash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByIsCashDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.desc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByIsCredit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCredit', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByIsCreditDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByPaidAmount() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortThenBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByCreditorName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'creditorName', Sort.asc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByIsCash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByIsCashDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.desc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByIsCredit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCredit', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByIsCreditDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCredit', Sort.desc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByPaidAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidAmount', Sort.asc);
    });
  }
...
extension ExpenseModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByCreditorName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByIsCash() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isCash');
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByIsCredit() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByPaidAmount() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryProperty
  ...
  QueryBuilder<ExpenseModel, String?, QQueryOperations> creditorNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'creditorName');
    });
  }

  QueryBuilder<ExpenseModel, String?, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, bool, QQueryOperations> isCashProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCash');
    });
  }

  QueryBuilder<ExpenseModel, bool, QQueryOperations> isCreditProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, double, QQueryOperations> paidAmountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, String?, QQueryOperations> paymentTypeProperty() {
    return QueryBuilder.apply(this, (query) {
