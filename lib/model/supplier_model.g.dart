...
extension SupplierModelQuerySortBy
  ...
  QueryBuilder<SupplierModel, SupplierModel, QAfterSortBy> sortByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<SupplierModel, SupplierModel, QAfterSortBy> sortByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierModelQuerySortThenBy
  ...
  QueryBuilder<SupplierModel, SupplierModel, QAfterSortBy> thenByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<SupplierModel, SupplierModel, QAfterSortBy> thenByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.desc);
    });
  }
...
extension SupplierModelQueryWhereDistinct
  ...
  QueryBuilder<SupplierModel, SupplierModel, QDistinct> distinctByBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierModelQueryProperty
  ...
  QueryBuilder<SupplierModel, double, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
